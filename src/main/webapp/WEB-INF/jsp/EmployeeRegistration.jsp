...
<script>
    ...
    <div class="form-raw">
        ...
        <div class=" from-raw col-sm-10">
            <div class=" from-raw col-sm-12">
            <div id="heading"><h1>Employee Registration Form</h1></div>
            ...
            <div class="row">
                           <div class="form-group col-md-6">
                               ...
                               <div class="col-md-5">
                                   <sform:select path="genderId" items="${genderList}" multiple="false" itemValue="id" itemLabel="name" class="form-control input-sm" />
                                   <div class="has-error">
